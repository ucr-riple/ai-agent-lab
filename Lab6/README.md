# Lab 6: Logic Layer — Tool Use & Reflection Design Patterns
...
```bash
cp ../Lab6/templates/src/engine/engine.py src/engine/
```
...
cp ../Lab6/templates/tests/engine/test_engine.py tests/engine/
```
